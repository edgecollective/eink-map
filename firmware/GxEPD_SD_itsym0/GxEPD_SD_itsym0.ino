...
void drawBitmaps_other()
{
  ...
  /*drawBitmapFromSD("linc.bmp", w2 - 200, h2 - 150);
  delay(2000);
  drawBitmapFromSD("s3.bmp", w2 - 200, h2 - 150);
  delay(2000);*/
  drawBitmapFromSD("s4.bmp", w2 - 200, h2 - 150);
  delay(2000);
  drawBitmapFromSD("sannyb.bmp", w2 - 128, h2 - 128);
  delay(2000);
  drawBitmapFromSD("bone5.bmp", w2 - 128, h2 - 128);
  delay(2000);
  drawBitmapFromSD("omy1.bmp", w2 - 200, h2 - 150);
  delay(2000);
}
